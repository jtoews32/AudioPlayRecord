...
- (void)useAlertStyle
{
    ...
    UIColor *color = [UIColor colorWithRed:64.0/255.0 green:144.0/255.0 blue:224.0/255.0 alpha:1.0];
    [colors addObject:(id)[color CGColor]];
/*    color = [UIColor colorWithRed:135.0/255.0 green:186.0/255.0 blue:235.0/255.0 alpha:1.0];
    [colors addObject:(id)[color CGColor]];    
    color = [UIColor colorWithRed:45.0/255.0 green:123.0/255.0 blue:197.0/255.0 alpha:1.0];
    [colors addObject:(id)[color CGColor]];*/
...
/*    self.highlightGradientLocations = [NSArray arrayWithObjects:
                                       ...
                                       nil];*/
    self.highlightGradientLocations = [NSArray arrayWithObjects:[NSNumber numberWithFloat:0.0f],nil];
...
-(void) useGreenStyle {
    ...
    UIColor *color = [UIColor colorWithRed:156.0/255.0 green:179.0/255.0 blue:29.0/255.0 alpha:1.0];
    [colors addObject:(id)[color CGColor]];
    self.normalGradientColors = colors;
    self.normalGradientLocations = [NSArray arrayWithObjects:
                                    [NSNumber numberWithFloat:0.0f],
    ...
    NSMutableArray *colors2 = [NSMutableArray arrayWithCapacity:4];
    color = [UIColor colorWithRed:177.0f/255.0f green:202.0f/255.0f blue:39.0f/255.0f alpha:1.0];
    [colors2 addObject:(id)[color CGColor]];
    self.highlightGradientColors = colors2;
    self.highlightGradientLocations = [NSArray arrayWithObjects:[NSNumber numberWithFloat:0.0f],nil];
...
-(void) useSingleColorStyle:(UIColor*)color {
    NSMutableArray *colors = [NSMutableArray arrayWithCapacity:1];
    [colors addObject:(id)[color CGColor]];
    self.normalGradientColors = colors;
    self.normalGradientLocations = [NSMutableArray arrayWithObjects:
    ...
    NSMutableArray *colors2 = [NSMutableArray arrayWithCapacity:1];
    color = [UIColor colorWithRed:0.004 green:0.694 blue:0.518 alpha:1.0];
    [colors2 addObject:(id)[color CGColor]];
    self.highlightGradientColors = colors2;
    self.highlightGradientLocations = [NSMutableArray arrayWithObjects:
                                        [NSNumber numberWithFloat:0.0f],
...
-(id) initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        const int SPINNER_SIZE = (2 * destRect.size.height) / 3;
        int margin = (destRect.size.height / 2) - (SPINNER_SIZE / 2);
        destRect.origin.y = margin;
        destRect.origin.x = (destRect.size.width) - margin - SPINNER_SIZE;
        destRect.size.width = SPINNER_SIZE;
        destRect.size.height = SPINNER_SIZE;
        
        activityIndicator = [[UIActivityIndicatorView alloc] initWithFrame:destRect];
        [activityIndicator setColor:[UIColor whiteColor]];
        [self addSubview:activityIndicator];
        
        self.strokeColor = [UIColor clearColor]; //[UIColor colorWithRed:0.076 green:0.103 blue:0.195 alpha:1.0];
...
- (void)layoutSubviews {
    ...
    destRect.size.width = SPINNER_SIZE;
    destRect.size.height = SPINNER_SIZE;
    [activityIndicator setFrame:destRect];
}

- (void)showActivityIndicator:(NSString*)withText {
    inActivity = TRUE;
...
- (void)dealloc 
{
//TODO : Make sure we aren't leaking stuff here....
